...
public class ServerActivity extends Activity {
    ...
    private class getConnectionString {
        private void GetAppDetails() {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://raw.githubusercontent.com/Dze237/vpn/main/appdetails.json",
        ...
        private void GetFileDetails() {
            ...
            RequestQueue queue = Volley.newRequestQueue(ServerActivity.this);
            queue.getCache().clear();
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://raw.githubusercontent.com/Dze237/vpn/main/filedetails.json",
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String Response) {
